...
class CommandsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        super().setUpTestData()
        cls.venue = VenueFactory(tap_list_provider=StemAndSteinParser.provider_name)
    ...
    def test_guess_manufacturer_good_people(self):
        ...
        manufacturers = [ManufacturerFactory.build(name=name) for name in mfg_names]
    ...
    def test_guess_manufacturer_stone(self):
        mfg_names = [
            "New Realm Brewing Company / Stone",
            "Stone Brewing ",
            "Stone",
            "Stone Brewing Co.",
            "Stone Brewing",
