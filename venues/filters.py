...
class VenueFilterSet(FilterSet):
    ...
    o = OrderingFilter(
        fields=[
            ...
            'taps__beer__new_style__name',
            'taps__beer__new_style__alternate_names__name',
        ],
    )
    ...
    class Meta:
        fields = {
            ...
            'taps__beer__new_style__name': DEFAULT_STRING_FILTER_OPERATORS,
            'taps__beer__new_style__alternate_names__name': DEFAULT_STRING_FILTER_OPERATORS,
        }
        model = models.Venue
